    ...
    //------------------------------
        ...
        screenMovers = {
            ...
            '1a': ["right", 1, "bottom", [true, '5a', '5aa', '10', '13', '19', '23']],
             1: [null, 1000, "bottom", 4],
             4: [null, 1000, "left", '5a', "right", '5aa'],
             
            // 1. Prospecting - left
             '5a': ["bottom", '7a'],
             '7a': ["bottom", '8a', "left", '7b'],
             '7b': ["bottom", '8b', "left", '7c'],
             '7c': ["left", '7d'],
             '7d': [false, '7b'],
             '8b': ["bottom", '9b'],
    ...
    $(function () {
        ...
        $(".mover").on("click", function (event) {
			...
			if (mm) {
				...
				$('#minimap-viewport').scrollTo($("#star"), SLIDE_TIME, {offset: -150});
			} else {
		...
		$('#minimap-viewport').scrollTo($("#star"), {offset: -150});
    });
